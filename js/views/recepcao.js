    ...
    return `
        <div class="row justify-content-center">
            <div class="col-md-9 col-lg-8 card-casamento p-4 p-md-5 text-center">
                <div class="mb-4">
                    <img src="https://casamentolucasamanda.github.io/site/images/icone-recepcao.png" alt="Recepção" class="badge-icon-local mb-3" style="height: 52px; filter: invert(31%) sepia(26%) saturate(1061%) hue-rotate(95deg) brightness(96%) contrast(92%);">
                ...
                <div class="border rounded-3 p-4 bg-white mb-4 shadow-sm text-center">
                    ...
                    <a href="${recepcao.mapsUrl}" target="_blank" rel="noopener noreferrer" class="btn btn-outline-success rounded-pill px-4 py-2 fw-semibold d-inline-flex align-items-center gap-2">
                        <img src="https://casamentolucasamanda.github.io/site/images/icone-local.png" alt="Local" class="badge-icon-verde"> Abrir no Google Maps
                    </a>
                </div>
                ...
                <div class="d-flex justify-content-center gap-3 flex-wrap mt-4">
                    <a href="/cerimonia" data-link class="btn btn-outline-secondary rounded-pill px-4 py-2 d-inline-flex align-items-center gap-2">Ver Cerimônia Civil <img src="https://casamentolucasamanda.github.io/site/images/icone-local.png" alt="Cerimônia" class="badge-icon-verde"></a>
