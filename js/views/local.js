        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-6 mb-4">
                <div class="card-casamento h-100 p-4 p-md-4 text-center d-flex flex-column justify-content-between">
                    <div>
                        <div class="mb-3">
                            <img src="https://casamentolucasamanda.github.io/site/images/icone-local.png" alt="Cerimônia" class="badge-icon-local mb-2" style="height: 46px; filter: invert(31%) sepia(26%) saturate(1061%) hue-rotate(95deg) brightness(96%) contrast(92%);">
            ...
            <div class="col-lg-6 mb-4">
                <div class="card-casamento h-100 p-4 p-md-4 text-center d-flex flex-column justify-content-between">
                    <div>
                        <div class="mb-3">
                            <img src="https://casamentolucasamanda.github.io/site/images/icone-recepcao.png" alt="Recepção" class="badge-icon-local mb-2" style="height: 46px; filter: invert(31%) sepia(26%) saturate(1061%) hue-rotate(95deg) brightness(96%) contrast(92%);">
